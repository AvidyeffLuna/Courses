...
import MobileFormulary from "./MobileFormulary/MobileFormulary";
import MobileTitle from "./MobileTitle/MobileTitle";

interface IMobileIndexProps {
  shoppingCart: IGetShoppingCartByIdResponse | IShoppingCartFailure;
}

export default function MobileIndex({ shoppingCart }: IMobileIndexProps) {
    ...
    <div className="overflow-hidden w-100">
      <Row className="px-5 py-5 mt-5">
        ...
        <Col lg={12} className="mt-4">
          <MobileFormulary shoppingCart={shoppingCart} />
        </Col>
      </Row>
    </div>
  );
