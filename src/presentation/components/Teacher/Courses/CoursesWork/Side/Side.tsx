...
import DeliverableTaskFinish from "./DeliverableTaskFinish/DeliverableTaskFinish";
...
export default function Side() {
  ...
  const getDeliverableComponent = () => {
    if (router.query?.finish_task && !getTaskIsCompleted())
      return <DeliverableTaskFinish />;
